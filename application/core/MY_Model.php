...
class MY_Model extends CI_Model {
	...
	var $tbl_prefix = null;				# table prefix name
	...
	public function __construct(){
		...
		require APPPATH."config/database".EXT;						# include config file /application/config/database.php
		$this->db_master = $active_group; 							# set database group
		$this->$tbl_prefix = $db[$this->db_master]['dbprefix'];	# set table prefix name
